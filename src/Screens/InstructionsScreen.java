...
public class InstructionsScreen extends Screen {
    ...
    public void initialize() {
        ...
        controlsLabel = new SpriteFont("Controls:   W- Jump/Swim up   A/D- Walk/Swim Left/Right   D- Crouch/Swim Down", 80, 140, "Times New Roman", 20, Color.white);
        objectiveLabel = new SpriteFont("Avoid the enemies and reach the gold block at the end of each level!", 30, 220, "Times New Roman",20, Color.white);
